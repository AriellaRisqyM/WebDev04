...
// Catatan: Namespace Admin/ disimpulkan dari perintah artisan, 
// dokumen asli mencantumkan App\Http\Controllers

use App\Http\Controllers\Controller; // Standar Laravel
use App\Models\User; 
...
class PasienController extends Controller
{
    ...
    {
        $pasiens = User::where("role", "pasien")->get(); // *Modifikasi: with('poli') dihapus agar sesuai dengan gambar di hal. 4*
